                    ...
                    <article class="post">
                        <a href="#">
                            <div class="post__thumb">
                                <img src="<?php if( has_post_thumbnail() ){echo get_thumbnail_url($article->ID);}else{echo get_template_directory_uri()."/img/noimage.png";} ?>" alt="<?php echo get_permalink($article->ID); ?>">
                            </div>
